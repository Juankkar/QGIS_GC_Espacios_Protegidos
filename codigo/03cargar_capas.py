...
ruta_de_trabajo = "C:\\Users\\jcge9\\Documents\\QGIS_GC_Espacios_Protegidos\\"
## Cambiamos la ubicación al direcotorio "source code"
os.chdir(f"{ruta_de_trabajo}codigo")
...
municipios_gc = QgsVectorLayer(r"..\\data\\gran_canaria\\municipios_gc.shp","Municipios GC") 
